...
class PostView extends GetView<PostController> {
            ...
            Container(
              ...
              child: GestureDetector(
                  ...
                  child: controller.clickButton.value
                      ? IconNames.close.tosvgPictureConvert(Colors.white,
                          width: 18, height: 18)
                      : IconNames.plus.tosvgPictureConvert(Colors.white,
                          width: 18, height: 18)),
            ),
            ScrollBar(
  ...
  Padding editinBar(String hintText2, Radius radius) {
    return Padding(
  ...
  Widget nameBar(UserController controller) {
    return Align(
      alignment: Alignment.topLeft,
      child: Padding(
        padding: const EdgeInsets.only(left: 8.0),
        child: Text(controller.userModel?.data?.username ?? "", style: grSText),
      ),
    );
  }
